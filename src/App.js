      ...
      <div className="app">
        <div className="header">
          ...
          <div className="header-menu">
            <a className="menu-link is-active" href="https://www.baidu.com">
              Apps
            </a>
            <a className="menu-link notify" href="https://www.baidu.com/">
              Your work
            </a>
            <a className="menu-link" href="https://www.baidu.com/">
              Discover
            </a>
            <a className="menu-link notify" href="https://www.baidu.com/">
              Market
        ...
        <div className="wrapper">
          ...
          <div className="main-container">
            <div className="main-header">
              <a className="menu-link-main" href="https://www.baidu.com/">
                All Apps
              </a>
              <div className="header-menu">
                <a className="main-header-link is-active" href="https://www.baidu.com/">
                  Desktop
                </a>
                <a className="main-header-link" href="https://www.baidu.com/">
                  Mobile
                </a>
                <a className="main-header-link" href="https://www.baidu.com/">
                  Web
                    ...
                    <div className="button-wrapper">
                      ...
                      <div className="menu">
                        <button className="dropdown">
                          <ul>
                            <li>
                              <a href="https://www.baidu.com/">Go to Discover</a>
                            </li>
                            <li>
                              <a href="https://www.baidu.com/">Learn more</a>
                            </li>
                            <li>
                              <a href="https://www.baidu.com/">Uninstall</a>
                            </li>
                          </ul>
                        </button>
                      </div>
                    ...
                    <div className="button-wrapper">
                      ...
                      <div className="pop-up">
                        ...
                        <div className="pop-up__subtitle">
                          ...
                          before continuing. <a href="https://www.baidu.com">Learn more</a>
                        </div>
